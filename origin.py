...
texto = fonte.render('Tempo | 10 ' , True, (255,255,255), (0,0,0))
...
def collision(click):
  ...
  for m in range(len(mosquito_arr)):
    ...
    if abs(click[0] - mosquito_arr[m][0]) < 10 and abs(click[1] - mosquito_arr[m][1]) < 10:
      print(pontos)
      print('hit!')   
      mosquito_arr.pop(m)
      break
...
while running:
  ...
  while game:
    ...
    for i in range(len(mosquito_arr)): 
      pygame.draw.circle(screen, (RED), mosquito_arr[i], 10)
